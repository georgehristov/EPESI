...
class Utils_RecordBrowser_Recordset_Query_Crits_Validator
{
    protected $tab;
    protected $fields;
    ...
    public function validate(Utils_RecordBrowser_Recordset_Query_Crits $crits, $record)
    {
    ...
    protected function validate_single(Utils_RecordBrowser_CritsSingle $crits, $record)
    {
        ...
        list($field, $subfield) = Utils_RecordBrowser_Recordset_Query_Crits_Single::parse_subfield($crits->get_field());
